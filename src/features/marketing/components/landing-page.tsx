...
export function LandingPage() {
	...
	const showInternal =
		isInternalToolsEnabled() || session.roles.includes("internal_staff");
	...
	return (
		<div className="mx-auto max-w-3xl px-5 py-16 lg:px-8 lg:py-24">
			...
			<h1 className="mt-8 font-serif text-4xl text-slate-950">
				Shopify AI Console
			</h1>
			<p className="mt-3 max-w-lg text-sm leading-6 text-slate-600">
				Backend app for the Shopify store. Merchant copilot, storefront AI, and
				operational tools.
			</p>
			...
			<nav className="mt-10 grid gap-4 sm:grid-cols-2">
				<Link className={cardClass} to="/app">
					...
					<span className="text-xs leading-5 text-slate-500">
						Embedded Shopify admin surface
					</span>
				</Link>
				...
				<Link className={cardClass} to="/install">
					...
					<span className="text-xs leading-5 text-slate-500">
						Connection setup and checklist
					</span>
				</Link>
