...
export default function PasswordResetEmail({ brandName, name, resetUrl }: PasswordResetEmailProps) {
	...
	return (
		<EmailLayout brandName={brandName} previewText="Reset your password">
			...
			<Link href={resetUrl} className="mt-1 mb-0 block text-sm leading-6 text-gray-900 break-all">
				{resetUrl}
			</Link>
