...
export const tables = {
	...
	organization: defineTable({
		...
		planDisplayName: v.optional(v.union(v.null(), v.string())),
		shopDomain: v.string(),
		shopId: v.string(),
		shopifyShopId: v.optional(v.union(v.null(), v.string())),
	})
		.index("name", ["name"])
		.index("slug", ["slug"])
		.index("shopDomain", ["shopDomain"])
		.index("shopId", ["shopId"]),
	member: defineTable({
		...
		role: v.string(),
		createdAt: v.number(),
		initials: v.optional(v.union(v.null(), v.string())),
		lastAuthenticatedAt: v.optional(v.union(v.null(), v.number())),
